    ...
    <section className="py-8 lg:py-24" id="contact">
      ...
      <div className="contact-container py-20 flex flex-col items-center justify-center">
        ...
        >
          {/* Email */}
          <a
            href="mailto:mohamed.hosni9997@gmail.com"
            className="contact-info flex items-center flex-1 p-4 font-bold text-slate-300 rounded-2xl"
          >
          ...
          {/* WhatsApp */}
          <a
            href="https://wa.me/201142941401"
            target="_blank"
            rel="noopener noreferrer"
            className="contact-info mt-5 sm:mt-0 flex items-center flex-1 p-4 font-bold text-slate-300 rounded-2xl"
          >
        ...
        <div className="form-container flex-2 mt-10">
          {isFormSubmitted ? (
            <p className="success-message text-center text-slate-300 font-bold text-base sm:text-3xl capitalize">
      ...
      <div className="footer text-right px-4 md:px-12">
        <h2 className="text-slate-300 font-bold text-base sm:text-3xl">
          ALL Right Reserved
          <span className="text-base sm:text-3xl"> M.Hosni</span>
        </h2>
      </div>
    </section>
  );
